...
__attribute__((section("__versions"))) = {
	...
	{ 0x84f8ca57, "get_user_pages" },
	{ 0x108e8985, "param_get_uint" },
	{ 0xd62c833f, "schedule_timeout" },
	{ 0xbbdcda50, "pci_unregister_driver" },
	{ 0x7ecb001b, "__per_cpu_offset" },
	{ 0xe082651a, "pci_bus_write_config_byte" },
	{ 0x37a0cba, "kfree" },
	{ 0x39e0db6e, "remap_pfn_range" },
	{ 0x3285cc48, "param_set_uint" },
	{ 0xedc03953, "iounmap" },
	{ 0x3f1899f1, "up" },
	{ 0x2b9ff55d, "__pci_register_driver" },
	{ 0xaacb7a5d, "put_page" },
	{ 0x8815aec2, "vmalloc_to_page" },
