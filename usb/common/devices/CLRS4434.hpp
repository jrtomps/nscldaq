...
CLRS4434<Controller,RdoList>::CLRS4434() 
  :
    m_pConfig(0)
{
}
...
template<class Controller, class RdoList>
CLRS4434<Controller,RdoList>::CLRS4434(const CLRS4434& rhs)
...
// Dont do anything.
template<class Controller, class RdoList>
CLRS4434<Controller,RdoList>& 
CLRS4434<Controller,RdoList>::operator=(const CLRS4434& rhs)
{
    return *this;
}
...
template<class Controller, class RdoList>
void  CLRS4434<Controller,RdoList>::onAttach(CReadoutModule& config)
{
//    std::cout << "Attaching CLRS4434" << std::endl;
    m_pConfig = &config;
...
template<class Controller, class RdoList>
void CLRS4434<Controller,RdoList>::Initialize(Controller& controller)
{
    ...
    if ((qx&1)==0) {
        throw "CLRS4434::Initialize(Controller&) Q==0 after simpleWrite16";
    }
}

template<class Controller, class RdoList>
void CLRS4434<Controller,RdoList>::addReadoutList(RdoList& list)
{
    addReadAll(list);
    addClear(list);
}
...
template<class Controller, class RdoList>
void CLRS4434<Controller,RdoList>::addClear(RdoList& list)
{
...
template<class Controller, class RdoList>
void CLRS4434<Controller,RdoList>::addReadAll(RdoList& list)
{
    int slot = m_pConfig->getIntegerParameter("-slot"); 
...
template<class Controller, class RdoList>
void CLRS4434<Controller,RdoList>::addRead(RdoList& list, int a)
{
    int slot = m_pConfig->getIntegerParameter("-slot"); 
