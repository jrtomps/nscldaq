...
template<class Controller, class RdoList> class CLRS4434;
...
class CLRS4434 : public CReadoutHardwareT<Controller,RdoList>
{
    ...
    */
    CLRS4434& operator=(const CLRS4434& rhs);
    ...
    */
    CLRS4434* clone() const {
        return new CLRS4434(*this);
    }
