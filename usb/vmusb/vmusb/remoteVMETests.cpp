...
static Warning msg("remoteVMETests requires a CVMUSBModule named \"remotevmusb\" controlled by a VMUSBReadout");
static Warning msg2("The remote controlled VMUSB must be able to interact with an XLM72V in slot 3");
