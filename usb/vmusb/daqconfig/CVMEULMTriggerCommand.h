...
#ifndef __CVMEULMTRIGGERCOMMAND_H
#define __CVMEULMTRIGGERCOMMAND_H
...
*/
class CVMEULMTriggerCommand : public CTCLObjectProcessor
{
private:
  CConfiguration& m_Config;

public:
  CVMEULMTriggerCommand(CTCLInterpreter& interp,
	      CConfiguration&  config,
	      std::string      commandName = std::string("VMEULMTrigger"));
  virtual ~CVMEULMTriggerCommand();
private:
  CVMEULMTriggerCommand(const CVMEULMTriggerCommand& rhs);
  CVMEULMTriggerCommand& operator=(const CVMEULMTriggerCommand& rhs);
  int operator==(const CVMEULMTriggerCommand& rhs) const;
  int operator!=(const CVMEULMTriggerCommand& rhs) const;
public:
