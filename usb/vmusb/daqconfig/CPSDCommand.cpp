...
*/
int
CPSDCommand::operator()(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
...
void
CPSDCommand::Usage(std::string msg, std::vector<CTCLObject>& objv)
{
  string result("ERROR: ");
  result += msg;
  result += "\n";
  ...
  result += "\n";
  result += "Usage\n";
  result += "    psd create name base-address\n";
  result += "    psd config name config-params...\n";
  result += "    psd cget name";
