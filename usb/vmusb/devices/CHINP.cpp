...
CHINP::Initialize(CVMUSB& controller)
{
  ...
  controller.vmeWrite32(fpga+FPGA_ABus*4, registerAmod, (uint32_t)0); // turn off reset
  controller.vmeWrite32(fpga+FPGA_ABus*4, registerAmod, (uint32_t)0); // wait
  controller.vmeWrite32(fpga+FPGA_ABus*4, registerAmod, (uint32_t)0); // wait
  controller.vmeWrite32(fpga+FPGA_ABus*4, registerAmod, (uint32_t)0); // wait
  controller.vmeWrite32(fpga+FPGA_ABus*4, registerAmod, (uint32_t)0); // wait
  controller.vmeWrite32(fpga+FPGA_ABus*4, registerAmod, (uint32_t)0); // wait
 ...
 // now set XLM to Unified readout mode, without internal ADC
  controller.vmeWrite32(fpga+ReadoutMode*4, registerAmod, (uint32_t)5); // ADC on, Unified On
  ...
  controller.vmeWrite32(fpga+FPGA_clear_veto*4, registerAmod, (uint32_t)1); // clear veto_reset
