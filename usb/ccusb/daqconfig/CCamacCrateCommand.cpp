...
*/
CCamacCrateCommand::CCamacCrateCommand(CTCLInterpreter&   interp,
...
/*!
   Destructor:
*/
CCamacCrateCommand::~CCamacCrateCommand()
{
}
//////////////////////////////////////////////////////////////////////
//////////////// Command processing //////////////////////////////////
...
*/
int
CCamacCrateCommand::operator()(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
...
*/
int
CCamacCrateCommand::create(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
  ...
  CCamacCrate<CCCUSB, CCCUSBReadoutList> hybrid_module;
...
*/
int
CCamacCrateCommand::config(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
  ...
  CReadoutModule* pModule = m_Config.findAdc(name);
  if (!pModule) {
    Usage("CamacCrate module does not exist", objv);
    return TCL_ERROR;
  }
...
*/
int
CCamacCrateCommand::cget(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
  if (objv.size() != 3) {
...
void
CCamacCrateCommand::Usage(std::string msg, std::vector<CTCLObject>& objv)
{
  string result("ERROR: ");
  result += msg;
  result += "\n";
  ...
  result += "\n";
  result += "Usage\n";
  result += "    CamacCrate create name crate_index\n";
  result += "    CamacCrate config name config-params...\n";
  result += "    CamacCrate cget name";
