...
**      Filename:   readmem.c
**
**      Purpose:    This example program uses the base Bit 3 Mirror API
...
**      Program:    readmem
**
**      Purpose:    Prints the first 256 bytes starting at 0x00000000
    ...
    )
{
    ...
    size_t          buffer_size;    /* Amount we want to read */
    ...
    buffer_size = NUM_BYTES * NUM_LINES;
...
"\n");
     ...
     fprintf(stderr,
"    USAGE: %s [-] [-t logical] [-u unit] [-a address]\n", prog_p);
