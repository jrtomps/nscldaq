#
#   package to support burning a DVD set for SEE.  This package is used by the
#   SEETF to burn a set of DVD's that export the data they take.
#
#  
...
namespace eval  DvdBurn {
	...
	set fifo [Fifo .mkisofs]

	exec cat $fifo &
	
	exec mkisofs  -r  -J -v -o $isoname $DVDRoot > $fifo  2> $fifo 
