    ...
    switch (size) {
      ...
      case BT_WIDTH_D32:
        ...
        if (IS_SET(unit_p->bt_status, BT_NEXT_GEN)) {
            ...
            if ((reg == BT_RDMA_ADDR) &&
                (IS_CLR(unit_p->bt_status, BT_PCI2PCI))) {
                btp_put_d16(unit_p, base_p, (bt_data16_t) (value >> BT_D16_SHFT));
                btp_put_d16(unit_p, (void *) ((bt_data8_t *) base_p + 2), (bt_data16_t) (value & BT_D16_MASK));
            } else {
                btp_put_d16(unit_p, base_p, (bt_data16_t) (value & BT_D16_MASK));
                if (IS_SET(unit_p->bt_status, BT_NEXT_GEN)) {
                    btp_put_d16(unit_p, (void *) ((bt_data8_t *) base_p + 2), (bt_data16_t) (value >> BT_D16_SHFT));
                } else {
                    btp_put_d8(unit_p, (void *) ((bt_data8_t *) base_p + 2), (bt_data8_t) ((value >> BT_D16_SHFT) & BT_D8_MASK));
                }
            }
        }
        break;
    ...
    bt_unit_t *unit_p)
{
    ...
    */
    unused = btk_get_io(unit_p, BT_REM_STATUS);
    ...
    */
    ...
    rem_id = btk_get_io(unit_p, BT_REM_CARD_ID);

    btk_put_io(unit_p, BT_REM_CARD_ID, 0x0);
    unused = btk_get_io(unit_p, BT_REM_CARD_ID);
    ...
    */
    switch(rem_id) {
        ...
        case BT_ID_PCI_FIBER_D64: /* PCi side of 704 */
            ...
            SET_BIT(unit_p->bt_status, BT_DMA_AVAIL);
            CLR_BIT(unit_p->logstat[BT_AXSRDP], STAT_DMA);
            retvalu = BT_PN_PCI_FIBER_D64;
            break;
            
        case BT_ID_VME_FIBER_D64: /* VME side of 704 */
            CLR_BIT(unit_p->bt_status, BT_PCI2PCI);
            SET_BIT(unit_p->bt_status, BT_DMA_AVAIL);
            retvalu = BT_PN_VME_FIBER_D64;
            break;
