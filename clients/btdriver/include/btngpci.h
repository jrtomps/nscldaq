...
#define	BT_AXSDP BT_AXSRDP	/* Old DP name references remote DP */
    ...
    */
    ...
    BT_DEV_GEO= BT_AXSGEO,
    BT_DEV_MCCTL=BT_AXSMCCTL,
    BT_DEV_CBLT =BT_AXSCBLT,
...
*/
#define MAX_IOREGS              (0x40)  /* maximum number of I/O registers */ 
...
*****/
    ...
    */
    ...
    /*
    ** Windows NT 983 specific infomation
    */
#elif defined(BT983)
    ...
    PKINTERRUPT         irq_obj_p;      /* Interrupt object from HAL */
...
#if FALSE       /* These are defined as int type in common area below.  */
    u_char      pio_addr_mod[BT_MAX_AXSTYPS];   /* Addr modifiers used for PIO */
    u_char      dma_addr_mod[BT_MAX_AXSTYPS];   /* Addr modifiers used for DMA */
    u_char      mmap_addr_mod[BT_MAX_AXSTYPS];  /* Addr modifiers used for MMAP*/
    u_char      swap_bits[BT_MAX_AXSTYPS];      /* Swap bit each logical dev */
    u_char      data_size[BT_MAX_AXSTYPS];      /* Data transfer size */
#endif
