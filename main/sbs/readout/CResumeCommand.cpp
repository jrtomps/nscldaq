...
*/
CResumeCommand::CResumeCommand(CTCLInterpreter& interp) :
  CTCLPackagedObjectProcessor(interp, string("resume"))
{
...
*/
string
CResumeCommand::usage()
{
  string result = "Usage\n";
  result       += "   resume\n";
  result       += " Attempts to restart a data taking run that is paused";
  return result;
}
