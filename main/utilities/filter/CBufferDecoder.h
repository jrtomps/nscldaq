...
class CBufferDecoder 
{
  ...
  CBufferTranslator* m_pTranslator;  // Pointer to the buffer translator
  protected:
  ...
  virtual CBufferTranslator* getBufferTranslator() {
  ...
  virtual CBuffer onBuffer(const CBuffer& buffer);
