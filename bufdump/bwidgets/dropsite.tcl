...
namespace eval DropSite {
    ...
    array set _defops \
        [list \
             ...
             move,mod  control \
             link,mod  alt     \
             copy,img  @[file join $::BWIDGET::SHARE "images" "opcopy.xbm"] \
             move,img  @[file join $::BWIDGET::SHARE "images" "opmove.xbm"] \
             link,img  @[file join $::BWIDGET::SHARE "images" "oplink.xbm"]]
