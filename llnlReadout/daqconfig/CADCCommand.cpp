...
*/
int
CADCCommand::operator()(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
...
*/
int
CADCCommand::cget(CTCLInterpreter& interp, vector<CTCLObject>& objv)
{
  if (objv.size() != 3) {
...
void
CADCCommand::Usage(std::string msg, std::vector<CTCLObject>& objv)
{
  string result("ERROR: ");
  result += msg;
  result += "\n";
