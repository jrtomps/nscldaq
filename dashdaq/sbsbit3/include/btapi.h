...
#else  /* !defined(BT973) && !defined(BT983) && !defined(BT15901) \
          && !defined(BT15991) && !defined(BT17903) && !defined(BT13908) */
...
#endif /* !defined(BT973) && !defined(BT983) && !defined(BT15901) \
          && !defined(BT15991) && !defined(BT17903) && !defined(BT13908) */
...
#elif defined(BT973) || defined(BT983)
#include "btwapi.h"
#if !defined(BT_NTDRIVER)
#define BT_NTDRIVER
#endif /* !defined(BT_NTDRIVER) */
/* defined(BT973) || defined(BT983) */
