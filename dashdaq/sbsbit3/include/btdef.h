...
#if     defined(BT983) && !defined(BT_WINNT)
#define BT_WINNT
#endif  /* defined(BT983) && !defined(BT_WINNT) */
...
#define BT_AMOD_GEO         (0x2F)  /* Geographical addressing */
#define BT_AMOD_MCCTL       (0X09) /* Multicast control register writes. */
#define BT_AMOD_CBLT        (0x0B) /* Chained block transfer.             */
...
#define BT_PN_PCI_FIBER_D64 85911020        /* Next Gen NanoBus PCI card    */
#define BT_PN_VME_FIBER_D64 85642852        /* Next Gen NanoBus VME card    */
