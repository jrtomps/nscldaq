...
#ifndef RECORD2RAW_VERSION_H
#include <dshusage/record2raw_version.h>
#endif

#ifndef RECORD2RAW_HELP_H
#include <dshusage/record2raw_help.h>
#endif
...
*
* Convert DSH records to raw data.  This program will also consume
* a BEGINRUN, ENDRUN, BADEND and CONTINUE records.
*
* @author  Eric Kasten
* @version 1.0.0
*/
class Record2Raw: public Main {
  ...
  *
  * Run the main loop. The record2raw main loop reads records
