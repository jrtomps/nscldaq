...
#ifndef DUMMYASCIIPRODUCER_VERSION_H
#include <dshusage/dummyasciiproducer_version.h>
#endif

#ifndef DUMMYASCIIPRODUCER_HELP_H
#include <dshusage/dummyasciiproducer_help.h>
#endif

using namespace daqhwyapi;

/**
* @var dummyasciiproducer_rtexception
* @brief Exception to throw for general runtime errors.
*
* Exception to throw for for general runtime errors.
*/
static RuntimeException dummyasciiproducer_rtexception;
...
* @version 1.0.0
*/
class DummyAsciiProducer: public Main {
  ...
  private: char my_sepchar;

  /*==============================================================*/
  /** @fn DummyAsciiProducer()
  ...
  * @return None
  */
  public: virtual ~DummyAsciiProducer() { }
    ...
    while (i < argc) { 
      ...
      if (argstr[0] == '-') { // Option argument
        if (argstr.equals("--version")) { 
          ...
          if (parmstr.size() > 0) {
            String str = parmstr;
            DSHUtils::convertEscapeCharacters(str);
            my_sepchar = str[0]; 
          } else {
            cerr << "Argument \"--separator\" requires an character parameter." << endl;
            return false;
          }
  ...
  */
  private: void mainloop() {
    ...
    for (;;) {
      ...
      ::write(1,(void*)(&my_sepchar),1);  // Separator
...
DummyAsciiProducer dummyasciiproducer;
